...
2.3.2.1 [Целевая аудитория](#целевая-аудитория)  
2.3.2.2 [Побочная аудитория](#побочная-аудитория)  
...
3.1.1.1 [Вход пользователя в приложение](#вход-пользователя-в-приложение)  
3.1.1.2 [Настройка профиля активного пользователя](#настройка-профиля-активного-пользователя)  
3.1.1.3 [Загрузка списка книг](#загрузка-списка-книг)  
3.1.1.4 [Просмотр информации об отдельной книге](#просмотр-информации-об-отдельной-книге)  
3.1.1.5 [Выход пользователя из учётной записи](#выход-пользователя-из-учётной-записи)  
3.1.1.6 [Регистрация нового пользователя после входа в приложение](#регистрация-нового-пользователя-после-входа-в-приложение)  
...
3.2.1.3 [Требования к доступности](#требования-к-доступности)  
